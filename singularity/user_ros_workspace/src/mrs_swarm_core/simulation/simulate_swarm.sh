...
then
  ...
  common_windows=('roscore' 'gazebo' 'dyn_reconfig' 'rqt' 'rviz' 'ros_bridge' 'draca_planner_server')
fi
...
curr_dir=$(pwd)
window_commands['draca_planner_server']='waitForRos; roscd draca_planner; chmod +x ./scripts/draca_planner_server.py ; rosrun draca_planner draca_planner_server.py --output=./data'
# #}
